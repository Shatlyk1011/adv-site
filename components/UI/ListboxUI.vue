...
<template>
  <Listbox v-model="selected">
    <div class="relative ">
      ...
      >
        <ListboxOptions
          @keydown.prevent.enter="$emit('update:selectedList', selected), $emit('update:modelValue', selected)"
        ...
        >
          <ListboxOption
            @click="$emit('update:selectedList', selected), $emit('update:modelValue', selected)"            
